// Lazarus Packages for Serial Communication do not support break signal
// generation, so Windows Hardware Access function_call and thread were
//used to achieve these two functions   (Metex M-6000m)
