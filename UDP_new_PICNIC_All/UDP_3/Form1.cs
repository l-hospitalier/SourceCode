...
// TriState new PIC-NIC　UDP通信によるA/D値　パラレルポート制御　LCD制御　C#プログラム
...
namespace UDP_3
{
    public partial class Form1 : Form
    {
        ...
        bool boo = false;
        byte m, ADCh;
        double temp, volt;   //byte RJ, RE, TRIS_RJ, TRIS_RE, AD_H, AD_L;
        ...
        void SetText()
        {
             ...
             temp = ((status[4] & 0x03) * 0xFF + status[5]) * 0.48828125;
             volt = ((status[4] & 0x03) * 0xFF + status[5]) * 0.0048828125;

             if (m == 2) { listBox1.Items.Add(" " + temp.ToString("f3") + " ℃ "); }
                     
                     if (m == 0) { textBox1.Text = volt.ToString("f3"); }
                else if (m == 1) { textBox2.Text = volt.ToString("f3"); }
                else if (m == 2) { textBox3.Text = temp.ToString("f3"); }
                else if (m == 3) { textBox4.Text = volt.ToString("f3"); }
                else if (m == 4) { textBox5.Text = volt.ToString("f3"); }
                else if (m == 5) { textBox6.Text = volt.ToString("f3"); }
                else if (m == 6) { textBox7.Text = volt.ToString("f3"); }
                else if (m == 7) { textBox8.Text = volt.ToString("f3"); };
