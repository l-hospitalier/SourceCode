...
begin
  if LUDPComponent1.GetMessage(st) > 0 then
    begin
       ...
       if m=3 then memo1.Append(temps);

              if m = 1 then Edit1.Text := volts
         else if m = 2 then Edit2.Text := volts
         else if m = 3 then Edit3.Text := volts
         else if m = 4 then Edit4.Text := temps
         else if m = 5 then Edit13.Text := volts
         else if m = 6 then Edit14.Text := volts
         else if m = 7 then Edit15.Text := volts
         else if m = 0 then Edit16.Text := volts
    end;
end;
