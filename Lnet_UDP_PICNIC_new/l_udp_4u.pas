  ...
  if LUDPComponent1.GetMessage(st) > 0 then
    begin
       ...
       if m=3 then memo1.Append(temps);
              ...
              if m = 0 then Edit1.Text := temps
         else if m = 1 then Edit2.Text := temps
         else if m = 2 then Edit3.Text := temps
         else if m = 3 then Edit4.Text := temps
         else if m = 4 then Edit13.Text := temps
         else if m = 5 then Edit14.Text := temps
         else if m = 6 then Edit15.Text := temps
         else if m = 7 then Edit16.Text := temps
    end;
end;
